...
class EXPORT SurfaceBatteryDriver : public IOService {
    ...
    static constexpr SMC_KEY KeyIB0R = SMC_MAKE_IDENTIFIER('I','B','0','R');
    static constexpr SMC_KEY KeyPB0R = SMC_MAKE_IDENTIFIER('P','B','0','R');
...
private:
    ...
    bool    bix_fail[BatteryManagerState::MaxBatteriesSupported] {true, true};
    int     quick_cnt {0};
    bool    bat_missing[BatteryManagerState::MaxBatteriesSupported] {false, false};
    bool    sync {false};
